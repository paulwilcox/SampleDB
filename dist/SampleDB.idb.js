...
class manager {
    ...
    async upgrade (db) { 
        ...
        for (let sourceKey of sourceKeys) { 
            ...
            // (order of non-numeric keys is by insertion).
            // This is if you want to return to defaulting 
            // to first column as the primary key.  But 
            // for now I believe an out-of-line autogenerated
            // key is the best.
            Object.keys(this.json[sourceKey][0])[0];
